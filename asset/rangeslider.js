...
(function (factory) {
    ...
    if (hiddenParentNodesLength) {
      for (var i = 0; i < hiddenParentNodesLength; i++) {
        ...
        if (hiddenParentNodes[i].style.setProperty) {
          hiddenParentNodes[i].style.setProperty(
            "display",
            "block",
            "important"
          );
  ...
  function Plugin(element, options) {
    ...
    this.DIRECTION_STYLE =
      constants.orientation[this.orientation].directionStyle;
  ...
  Plugin.prototype.update = function (updateAttributes, triggerSlide) {
    ...
    this.handleDimension = getDimension(
      this.$handle[0],
      "offset" + ucfirst(this.DIMENSION)
    );
    this.rangeDimension = getDimension(
      this.$range[0],
      "offset" + ucfirst(this.DIMENSION)
    );
    ...
    var pos = this.getRelativePosition(e),
      ...
      setPos =
        this.orientation === "vertical"
          ? this.maxHandlePos - (pos - this.grabPos)
          : pos - this.grabPos;
  ...
  Plugin.prototype.getRelativePosition = function (e) {
    ...
    if (typeof e.originalEvent["client" + ucCoordinate] !== "undefined") {
      ...
      e.currentPoint &&
      typeof e.currentPoint[this.COORDINATE] !== "undefined"
    ) {
